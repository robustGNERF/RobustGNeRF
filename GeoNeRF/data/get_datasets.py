...
from data.objaverse import Objaverse_Dataset
...
def get_training_dataset(args, downsample=1.0):
    train_datasets = [
        ...
        #     burst_training = args.burst_training
        # ),
        Objaverse_Dataset(
            root_dir=args.llff_path,
            split="train",
    ...
    weights = [1.0] #[0.5, 0.22, 0.12, 0.16]
...
def get_validation_dataset(args, downsample=1.0):
    ...
    elif args.dataset_name == "objaverse":
        val_dataset = Objaverse_Dataset(
            root_dir=args.llff_test_path if not args.llff_test_path is None else args.llff_path,
            split="val",
            max_len=max_len,
            downSample=args.downscale_val,
