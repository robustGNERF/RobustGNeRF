...
class CustomArgumentParser(configargparse.ArgumentParser):
    ...
    def config_parser(cls):
        ...
        parser.add_argument('--lambda_blur_loss', type=float, default=0)
        parser.add_argument('--lambda_latent_loss', type=float, default=0)
        ...
        parser.add_argument("--restormer_ckpt_path", type=str, default=None)
