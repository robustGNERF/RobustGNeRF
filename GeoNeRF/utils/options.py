...
def config_parser():
    ...
    # Datasets options
    parser.add_argument("--dataset_name", type=str, default="llff", choices=["llff", "nerf", "dtu", 'objaverse'],)
    ...
    # Training options
    parser.add_argument("--load_ckpt", type=str, default=None, help="Path to ckpt")
    ...
    parser.add_argument('--dip_feat', default=False, action="store_true")
    parser.add_argument('--bpn_prenet', default=False, action="store_true")
    parser.add_argument('--burst_training', default=False, action="store_true")
    parser.add_argument("--downscale_val", type=float, default=1.0)
